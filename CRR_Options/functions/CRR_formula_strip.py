def CRR_formula_strip(S0, K, T, u, d, r):
    """
    
    CRR_formula_strip(S0, K, T, u, d, r) = initial price of a strip option using CRR formula

    CRR formula = pi_c + 2 * pi_p
...
answer = round(CRR_formula_strip(S0, K, T, u, d, r), 2)
print(answer)  # 8.53
